...
var partial = module.exports.partial = function(name, locals, callback) {
    ...
    if (fnamePartial == undefined) cb('NO FILE FOUND FOR PARTIAL ' + name);
    if (fnamePartial.match(/\.kernel$/)) {
        ...
        var rendered = partialSync(fnamePartial, localdata, cb);
        return rendered;
...
var partialKernel = function(name, locals, callback) {
    ...
    if (fnamePartial == undefined) done('NO FILE FOUND FOR PARTIAL ' + name);
...
var partialSync = module.exports.partialSync = function(fname, locals, done) {
    ...
    if (fnamePartial == undefined) done('NO FILE FOUND FOR PARTIAL ' + fname);
